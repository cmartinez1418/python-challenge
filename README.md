...
PyPoll: code reads through election data to find the total number of votes, who the candidates were, how many votes each candidate received, the percentage of votes for each candidate, and the election winner.
